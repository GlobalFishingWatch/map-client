...
import LayerManagementStyles from 'styles/components/map/layer-management.module.scss'
      ...
      <div className={LayerManagementStyles.layerManagement}>
        ...
        <button
          className={classnames(
            ...
            LayerManagementStyles.layerButton,
            {
              [MapButtonStyles._disabled]:
                !this.props.workspaceLayers.filter((e) => e.added === true).length > 0,
            },
