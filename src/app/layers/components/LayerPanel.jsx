...
import LayerItem from 'app/layers/containers/LayerItem'
import {
  LAYER_TYPES,
...
import AccordionHeader from 'app/components/Shared/AccordionHeader'
import BasemapPanel from 'app/basemap/containers/BasemapPanel'
import LayerManagement from 'app/layers/containers/LayerManagement'
      ...
      <div>
        <div className={AccordionStyles.accordion}>
          ...
          <ExpandItem active={this.state.expand === 'ACTIVITY_LAYERS'} accordion>
            <ul className={LayerListStyles.list}>{activityLayers}</ul>
          </ExpandItem>
          <AccordionHeader
        ...
        {this.state.expand !== null && <LayerManagement />}
      </div>
    )
  }
}
