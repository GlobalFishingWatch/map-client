...
const defaultWorkspace = {
  workspace: {
    ...
    map: {
      center: [-4.039617826768424, -142.20703125],
      zoom: 3,
      layers: [
        {
        ...
        },
        {
          ...
          type: 'ClusterAnimation',
          url:
            'https://api-dot-skytruth-pleuston.appspot.com/v2/tilesets/525-indo-public-parametrize-v5',
        ...
        },
        {
          ...
          url:
            'https://api-dot-skytruth-pleuston.appspot.com/v2/tilesets/gfw-tasks-658-reefer-uvi-v4',
          id: 'reefers',
        ...
        },
        {
          ...
          description:
            "This layer contains all of the Marine Protected Areas (MPAs) that are published in <a href='https://www.protectedplanet.net/' target='_blank'>Protected Planet WDPA</a>.",
        ...
        },
        {
          title: 'EEZ',
          description:
            'EEZ stands for Exclusive Economic Zone and is a state’s sovereign waters, which extend 200 nautical miles from the coast. The EEZ layer was created using the data available from marineregions.org.',
        ...
        },
        {
          ...
          type: 'CartoDBAnimation',
          url:
            'http://cartodb.skytruth.org/user/production/api/v2/viz/32d46386-1ed0-11e7-ad57-0242ac110006/viz.json',
          id: '6',
          label: 'WPP NRI',
          description:
            'The WPP-NRI (Wilayah Pengelolaan Perikanan Negara Republik Indonesia) are fisheries management areas for fishing, conservation, research, and fisheries development which covers inland waters, archipelagic waters, territorial sea, within and outside the exclusive economic zone of Indonesia.',
          added: true,
          library: false,
          opacity: 1,
        },
  ...
  metadata: {
    ...
    urls: {
      ...
      load:
        'https://api-dot-skytruth-pleuston.appspot.com/v2/workspaces/vizz-default-workspace-v16',
      visualization:
        'http://wp-dev.globalfishingwatch.org/legacy-map/workspace/vizz-default-workspace-v16',
    },
  },
}
