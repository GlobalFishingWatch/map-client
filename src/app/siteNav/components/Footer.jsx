...
import { ReactComponent as LDFLogo } from 'assets/logos/ldf_logo_white.svg'
    ...
    return (
      <div>
        {this.props.isExpanded && (
          <div className={FooterStyles.veil} onClick={this.props.onClose} />
        )}
        <footer className={footerClass}>
          <div className={FooterStyles.closeButton} onClick={this.props.onClose}>
              ...
              <div className={FooterStyles.logosFooter}>
                <div className={FooterStyles.partnerSection}>
                  ...
                  <ul className={FooterStyles.logoList}>
                    ...
                    <li className={FooterStyles.logoItem}>
                      <img className={FooterStyles.logo} src={GoogleLogo} alt="Google" />
                    </li>
                  </ul>
                </div>
              ...
              <div className={FooterStyles.mapSection}>
                <ul className={FooterStyles.navList}>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={SITE_URL}>
                      Home
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/transparency-platform/`}>
                      Our Platform
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/research/`}>
                      Research
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/use-the-data/`}>
                      Use the Data
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/initiatives/`}>
                      Initiatives
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/publications/`}>
                      Publications & Tools
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a
                      ...
                      href={`${SITE_URL}/transparency-makes-a-difference/`}
                    >
                      Making a Difference
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/media-center/`}>
                      Media Center
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/about-us/`}>
                      Our Mission
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/contact-us/`}>
                      Contact us
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/terms-of-use/`}>
                      Terms of use
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <a className={FooterStyles.navLink} href={`${SITE_URL}/privacy-policy/`}>
                      Privacy policy
                    </a>
                  </li>
                  <li className={FooterStyles.navItem}>
                    <span className={FooterStyles.navLink} onClick={this.props.onOpenSupportModal}>
                      Support
                    </span>
                  </li>
                </ul>
                <div className={FooterStyles.socialSection}>
                  ...
                  >
                    ...
                    <SubscribeIcon
                      className={classnames(IconStyles.icon, FooterStyles.iconSubscribe)}
                    />
                  </a>
                  <div className={FooterStyles.socialLinks}>
                    ...
                    <ul className={FooterStyles.socialList}>
                      <li className={FooterStyles.socialItem}>
                        ...
                        >
                          <TwitterIcon
                            className={classnames(IconStyles.icon, FooterStyles.iconTwitter)}
                          />
                        </a>
                      </li>
                      <li className={FooterStyles.socialItem}>
                        ...
                        >
                          <FacebookIcon
                            className={classnames(IconStyles.icon, FooterStyles.iconFacebook)}
                          />
                        </a>
                      </li>
                    </ul>
