...
import Footer from 'app/siteNav/components/Footer'
import MapFooterStyles from 'styles/components/map/map-footer.module.scss'
    ...
    return (
      <span
        dangerouslySetInnerHTML={{
          __html: this.props.attributions.join(' · '),
        }}
      />
    )
  }
    ...
    return (
      <div className={MapFooterStyles.overflowContainer}>
        <div className={MapFooterStyles.mapFooter}>
          ...
          <div
            className={classnames(MapFooterStyles.options, {
              [MapFooterStyles._embed]: this.props.isEmbedded,
            })}
          >
