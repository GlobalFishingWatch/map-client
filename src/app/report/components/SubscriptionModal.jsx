...
import SelectorStyles from 'styles/components/shared/selector.module.scss'
...
import { SUBSCRIBE_SETTINGS } from 'app/config'
  ...
  render() {
    ...
    if (status === REPORT_STATUS.sent || status === REPORT_STATUS.error) {
      return (
        <div className={ReportPanelStyles.subscriptionModal}>
          <div className={ReportPanelStyles.subscriptionInfo}>{statusText}</div>
          <div
    ...
    return (
      <div className={ReportPanelStyles.subscriptionModal}>
        ...
        {process.env.REACT_APP_FEATURE_FLAG_SUBSCRIPTIONS && (
          <div
            className={classnames(
