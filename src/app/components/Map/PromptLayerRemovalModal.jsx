...
import PromptLayerStyles from 'styles/components/map/prompt-layer.module.scss'
    ...
    return (
      <div>
        ...
        <div className={PromptLayerStyles.promptLayer}>
          <p className={PromptLayerStyles.layerDescription}>
            You are about to remove a custom layer, which is part of your workspace and cannot be
            restored from the layer library once deleted.
          </p>
          <p className={PromptLayerStyles.layerDescription}>Are you sure you want to proceed?</p>
        </div>
      </div>
    )
  }
