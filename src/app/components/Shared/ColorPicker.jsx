...
import { PALETTE_COLORS, PALETTE_COLORS_LAYERS } from 'app/config'
import 'styles/components/map/layer-blending.module.scss'
import InputRange from 'react-input-range'
import colorPickerStyles from 'styles/components/shared/color-picker.module.scss'
  ...
  render() {
    ...
    return (
      <div className={colorPickerStyles.colorPicker}>
        ...
        {onShowLabelsToggle && (
          <div className={colorPickerStyles.section}>
            <div onClick={this.props.onShowLabelsToggle}>
              <IconButton icon="labels" activated={showLabels} label="Show labels" />
            </div>
          </div>
        )}
      </div>
