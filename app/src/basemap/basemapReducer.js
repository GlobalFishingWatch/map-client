...
const initialState = {
  ...
  basemaps: [
    ...
    },
    {
      ...
      type: 'Basemap',
      url: 'https://api.mapbox.com/styles/v1/enriquetuya/cj6dnii820sxe2rlpl7y238fb/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZW5yaXF1ZXR1eWEiLCJhIjoiY2loNmFwYjJuMDlzZnR4bHh3NnRyNmQxcCJ9.vf_v5i6RWNz5Q7rglf35pQ'
    },
    {
      title: 'Deep Blue',
      label: 'Deep Blue',
