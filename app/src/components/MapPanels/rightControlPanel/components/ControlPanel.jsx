...
import MenuLink from 'components/MapPanels/rightControlPanel/components/MenuLink';
import SubMenu from 'components/MapPanels/rightControlPanel/containers/SubMenu';
