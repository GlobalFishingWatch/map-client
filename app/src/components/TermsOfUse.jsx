    ...
    return (<div>
      ...
      <section>
        ...
        <p>
           ...
           By clicking “I agree”, you are bound by the terms of this Agreement. If you choose not to click on “I agree”
           you will be redirected from this website (“Site”).
        ...
        <ol>
          ...
          <li>
            ...
            <ol>
              <li>
                Prohibited Uses. As a condition of Your use of the Site and the Services, You warrant to SkyTruth that
                You will only use the Services for a lawful purpose and
              ...
              <li>
                ...
                <ol>
                  <li>
                     interfere, disrupt, or attempt to gain unauthorized access to
                     other accounts or any other computer network;
                  </li>
                  <li>
                    disseminate, store or transmit viruses, trojan horses, or any other malicious code or program; or
                  </li>
                  <li>
                    engage in any other activity deemed by SkyTruth to be in conflict
                    with these Terms (including any Third Party Provider terms referenced in Section 2 below).
                  </li>
                </ol>
              </li>
              <li>
                Indemnity. You agree to indemnify, hold harmless and, at SkyTruth’s request, defend
              ...
              <li>
                ...
                <ol>
                  <li>
                    that map data and related content are provided for informational
                    purposes only, and SkyTruth makes no warranties regarding the same;
                  </li>
                  <li>
                    that the information on the Site is not updated in real-time,
                    and therefore the map results may not be accurate;
                  </li>
                  <li>
                     SkyTruth assumes no responsibility for Your use of or actions in reliance on
              ...
              <li>
                Reservation of Rights. SkyTruth reserves all rights not expressly granted to
                ...
                and other content, if applicable.
              </li>
            </ol>
          </li>
          <li>
            ...
            <ul>
              <li>
                <a href="http://earthengine.google.org/terms" target="_blank">Google Earth Engine</a>
              </li>
              <li>
                <a href="http://www.google.com/intl/en_US/help/terms_maps.html" target="_blank">Google Maps/Earth</a>
              </li>
              <li>
                <a href="https://cloud.google.com/terms/service-terms" target="_blank">Google Cloud Platform</a>
              </li>
              <li>
                <a href="http://cartodb.com/terms" target="_blank">CartoDB</a>
              </li>
              <li>
                <Link to="/orbcomm">Orbcomm</Link>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                Site are covered by a single notification, a representative list of such works as located on the Site;
              </li>
              <li>
                The address, telephone number and electronic mail address of the complaining party
              </li>
              <li>
              ...
              <li>Your electronic or physical signature (as appropriate).</li>
            </ol>
            <p>
              The designated Copyright Agent to receive notifications of claimed infringement is:
              SkyTruth Tel: <a href="tel:1 (304) 885-4581">+1 (304) 885-4581</a>
              Email: <a href="dmcaagent@skytruth.org">dmcaagent@skytruth.org</a>.
            </p>
          </li>
        </ol>
        <ol>
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                between You and SkyTruth other than pursuant to these Terms.
              </li>
              <li>
                 You must fully comply with all applicable export laws,
                 ...
                 approval for export without first having obtained such license or other approval.
              </li>
              <li>
                The Agreement constitutes the entire agreement
                between the parties and supersedes any prior or contemporaneous
                written or oral agreement or understanding with respect to its subject matter.
              </li>
              <li>
                You understand and acknowledge that this Beta Version of Global
                ...
                or any information about the Global Fishing Watch Beta Version to any third party.
              </li>
            </ol>
          </li>
          <li>
            ...
            <p>
              ...
              Site should be directed to info@skytruth.org.
            </p>
          </li>
        </ol>
      </section>
