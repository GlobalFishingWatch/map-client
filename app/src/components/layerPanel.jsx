...
export default function (props) {
  ...
  title_accordion.push(<div className={layerPanel.title_acordion}>Basemap <div className={layerPanel.content_box}><div className={layerPanel.box_basemap}></div><div className={layerPanel.box_image_basemap}></div></div></div>);
          ...
          return (
            <AccordionItem title={item} key={item} className={layerPanel.title_accordion}>
              <div className={layerPanel.content_accordion}>
                {item === title_accordion[0] ? <div><p className={layerPanel.text_search}>advanced search</p><span className={layerPanel.button_advanced_search}>ADVANCED SEARCH</span></div> : null}
