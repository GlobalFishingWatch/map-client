...
export const TIMELINE_MAX_DATE_EXTENT = [new Date(Date.UTC(2012, 0, 1)), new Date()];
...
export const TIMELINE_OUTER_DATE_EXTENT = [new Date(Date.UTC(2012, 0, 1)), new Date(Date.UTC(2016, 7, 1))];
export const TIMELINE_INNER_DATE_EXTENT = [new Date(Date.UTC(2015, 0, 1)), new Date(Date.UTC(2015, 0, 30))];
