...
import { clearVesselInfo, addVessel, hideVesselsInfoPanel } from 'vesselInfo/vesselInfoActions'; // OUTSIDE
import { setEncountersInfo, clearEncountersInfo } from 'encounters/encountersActions';  // OUTSIDE
import { clearHighlightedVessels, clearHighlightedClickedVessel } from '../activityLayers/heatmapActions';
import { zoomIntoVesselCenter } from './mapViewportActions';
import { trackMapClicked } from '../../analytics/analyticsActions';  // TODO OUTSIDE
import { LAYER_TYPES } from '../../constants'; // TODO
import { POLYGON_LAYERS_AREA, FORMAT_DATE } from '../../config'; // TODO
